...
const PPUL_PLAN = [
  {
    ...
    sortOrder: 0,
    exercises: [
      { name: "Incline barbell press", muscleGroup: "Chest, Triceps, Front delts", targetSets: 2, repRange: "4–6", rir: 2, notes: "Upper chest strength anchor", sortOrder: 0 },
      ...
      { name: "OHP (barbell or Smith)", muscleGroup: "Shoulders, Triceps", targetSets: 2, repRange: "5–7", rir: 1, notes: "Shoulder strength movement", sortOrder: 2 },
      ...
      { name: "Hack squat or leg press", muscleGroup: "Quads, Glutes", targetSets: 2, repRange: "8–12", rir: 2, notes: "Main quad compound, feet narrow", sortOrder: 5 },
  ...
  },
  {
    ...
    sortOrder: 1,
    exercises: [
      { name: "Deadlift (conventional)", muscleGroup: "Back, Hamstrings, Glutes", targetSets: 2, repRange: "4–6", rir: 2, notes: "Strength anchor — ham + back in one", sortOrder: 0 },
      { name: "Weighted pull-up", muscleGroup: "Back, Biceps", targetSets: 2, repRange: "4–6", rir: 2, notes: "Width + strength", sortOrder: 1 },
      { name: "Barbell row", muscleGroup: "Back, Biceps", targetSets: 2, repRange: "5–8", rir: 2, notes: "Thickness — mid/lower trap", sortOrder: 2 },
      { name: "Face pull", muscleGroup: "Rear Delts, Back", targetSets: 2, repRange: "15", rir: 0, notes: "Rear delt + shoulder health", sortOrder: 3 },
      { name: "Incline dumbbell curl", muscleGroup: "Biceps, Forearms", targetSets: 2, repRange: "10–12", rir: 1, notes: "Long head stretch — best for bicep peak", sortOrder: 4 },
      { name: "Romanian deadlift", muscleGroup: "Hamstrings, Glutes, Back", targetSets: 2, repRange: "8–10", rir: 2, notes: "Ham stretch under load", sortOrder: 5 },
  ...
  },
  {
    ...
    sortOrder: 2,
    exercises: [
      { name: "Flat dumbbell press", muscleGroup: "Chest, Triceps, Front delts", targetSets: 2, repRange: "8–10", rir: 1, notes: "Different angle to Push day", sortOrder: 0 },
      ...
      { name: "Underhand lat pulldown", muscleGroup: "Back, Biceps", targetSets: 2, repRange: "10–12", rir: 1, notes: "Lower lat focus — width from below", sortOrder: 2 },
      { name: "Single arm dumbbell row", muscleGroup: "Back, Biceps", targetSets: 2, repRange: "10–12", rir: 1, notes: "Full stretch at bottom", sortOrder: 3 },
      ...
      { name: "EZ bar curl", muscleGroup: "Biceps, Forearms", targetSets: 2, repRange: "10–12", rir: 1, notes: "Control the eccentric", sortOrder: 5 },
  ...
  },
  {
    ...
    sortOrder: 3,
    exercises: [
      { name: "Barbell squat", muscleGroup: "Hamstrings, Quads, Glutes", targetSets: 2, repRange: "5–8", rir: 2, notes: "Strength anchor — glute + ham dominant", sortOrder: 0 },
      { name: "Nordic curl", muscleGroup: "Hamstrings, Glutes", targetSets: 2, repRange: "6–8", rir: 1, notes: "Eccentric ham overload — best ham builder", sortOrder: 1 },
      { name: "Hip thrust (barbell)", muscleGroup: "Glutes, Hamstrings", targetSets: 2, repRange: "8–12", rir: 1, notes: "Glute max — hold at top", sortOrder: 2 },
      { name: "Cable hip abduction", muscleGroup: "Abductors, Glutes", targetSets: 2, repRange: "12–15", rir: 0, notes: "Glute med + outer hip — stage width", sortOrder: 3 },
      { name: "Cable hip flexor raise", muscleGroup: "Hip Flexors, Quads", targetSets: 2, repRange: "12–15", rir: 0, notes: "Standing cable, knee drives up", sortOrder: 4 },
